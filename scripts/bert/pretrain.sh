mpirun --allow-run-as-root --tag-output -np 256 --hostfile /home/ubuntu/efs/hosts32  -map-by ppr:4:socket -mca pml ob1 -mca btl ^openib  -mca btl_tcp_if_include ens5 -x NCCL_DEBUG=INFO -x NCCL_SOCKET_IFNAME=ens5 \
	...
	python run_pretraining_hvd.py \
		...
		--num_steps 28125 --max_seq_length 128 --short_seq_prob 1.0 --lr 1e-4 --warmup_ratio 0.01 \
		--batch_size 32  --max_predictions_per_seq 20 \
		--raw --ckpt_dir ./np256_ckpt_dir 2>&1
